 ...
 * > `file.result`.
 *
 * @type {(options: Options) => import("./complex-types")._UtilReplaceReturnType<import('unified').Compiler<Root, ReactNode>, ReactNode>}
 */
const compiler = (options) => {
  ...
  return (node) => {
    ...
    let result = toH.bind(this)(h, tableCellStyle(node), options.prefix)
 ...
 */
export default function rehypeReactPlugin(options) {
  // @ts-expect-error: 'this' implicitly has type 'any' because it does not have a type annotation.
  // type-coverage:ignore-next-line
  Object.assign(this, {Compiler: compiler(options)})
}

/**
 * Compile directly Rehype to React nodes.
 *
 * @param {Root} node
 ...
 */
// @ts-ignore
export const rehypeToReact = (node, options) => compiler(options)(node)
